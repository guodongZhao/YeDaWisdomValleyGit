        ...
        factory(window['H'] = {
            ...
            dateTip: function (element, okCallback, cancelCallback) {
                ...
                html += '<div class="H-select-items">';
                    ...
                    html += '<div class="H-select-item H-font-size-16 H-theme-font-color-black H-center-all H-height-45">今天</div>';
                html += '<div class="H-select-item H-font-size-16 H-theme-font-color-black H-center-all H-height-45">明天</div>';
                html += '<div class="H-select-item H-font-size-16 H-theme-font-color-black H-center-all H-height-45">后天</div>';
